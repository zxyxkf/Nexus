...
const CREATE_TABLES_SQL = {
  ...
  mysql: [
    ...
    `CREATE TABLE IF NOT EXISTS task_reject_record (
      ...
      designer_id INT,
      designer_name VARCHAR(100) DEFAULT '',
      designer_complete_time DATETIME NULL,
      applied_score DECIMAL(10,2) DEFAULT 0,
      create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
...
async function initDatabase() {
  try {
    ...
    const alterSqls = mode === 'mysql' ? [
      ...
      `ALTER TABLE task_reject_record ADD COLUMN designer_id INT`,
      `ALTER TABLE task_reject_record ADD COLUMN designer_name VARCHAR(100) DEFAULT ''`,
      `ALTER TABLE task_reject_record ADD COLUMN designer_complete_time DATETIME NULL`,
      `ALTER TABLE task_reject_record ADD COLUMN applied_score DECIMAL(10,2) DEFAULT 0`,
      ...
      `ALTER TABLE task_reject_record ADD COLUMN designer_id INTEGER`,
      `ALTER TABLE task_reject_record ADD COLUMN designer_name TEXT DEFAULT ''`,
      `ALTER TABLE task_reject_record ADD COLUMN designer_complete_time TEXT`,
      `ALTER TABLE task_reject_record ADD COLUMN applied_score REAL DEFAULT 0`,
