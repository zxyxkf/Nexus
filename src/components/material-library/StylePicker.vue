...
<style scoped>.style-picker { width:100%; }.style-images-panel { margin-top:10px; padding:10px; border:1px solid var(--el-border-color-lighter); border-radius:6px; }.style-images-toolbar { display:flex; justify-content:space-between; align-items:center; margin-bottom:10px; color:var(--el-text-color-secondary); font-size:12px; }.style-image-grid { display:grid; grid-template-columns:repeat(5,minmax(0,1fr)); gap:8px; max-height:270px; overflow:auto; }.style-image { position:relative; border:2px solid transparent; padding:0; aspect-ratio:1; overflow:hidden; border-radius:4px; cursor:pointer; background:var(--el-fill-color-light); }.style-image.selected { border-color:var(--el-color-primary); }.style-image img { width:100%; height:100%; object-fit:cover; }.checkmark { position:absolute; right:4px; top:4px; width:18px; height:18px; border-radius:50%; background:var(--el-color-primary); color:#fff; font-size:12px; line-height:18px; }.empty-hint { display:block; padding:14px; text-align:center; color:var(--el-text-color-placeholder); }</style>
